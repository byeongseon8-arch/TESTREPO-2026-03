...
public class DynamicBeat extends JFrame {
	...
	public void screenDraw(Graphics2D g) {
		...
		if(isGameScreen)
		{
			g.drawImage(noteRouteImage, 478, 30, null);
			g.drawImage(noteRouteImage, 582, 30, null);
			g.drawImage(noteRouteImage, 686, 30, null);
			g.drawImage(noteRouteImage, 790, 30, null);
			g.drawImage(noteRouteImage, 890, 30, null);
			g.drawImage(noteRouteImage, 994, 30, null);
			g.drawImage(noteRouteImage, 1098, 30, null);
			g.drawImage(noteRouteImage, 1202, 30, null);
