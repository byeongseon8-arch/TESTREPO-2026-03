...
class TV{
	...
	public TV(String brandName, int year, int inch, String color) {
	...
	public void show() {		
		System.out.printf("%s에서 만든 %d년형 %d인치 %sTV",this.brandName,this.year,this.inch,this.color);
	}	
}

class ColorTV extends TV{
	public ColorTV(String brandName, int year, int inch, String color) {
		super(brandName, year, inch, color);
		System.out.println();
	}
...
public class C05Ex {
	...
	public static void main(String[] args) {
		TV myTV = new ColorTV("삼성", 2026, 32, "검정"); 
		myTV.show();
	}
}
