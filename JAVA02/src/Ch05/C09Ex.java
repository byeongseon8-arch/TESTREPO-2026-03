...
class Employee{
	...
	public String toString() {
		return "Employee [" + (name != null ? "name=" + name + ", " : "") + "age=" + age + ", "
				+ (addr != null ? "addr=" + addr : "") + "]";
	}
...
class Parttimer extends Employee{
	...
	@Override
	public String toString() {
		return "Parttimer [hour_pay=" + hour_pay + ", " + (name != null ? "name=" + name + ", " : "") + "age=" + age
				+ ", " + (addr != null ? "addr=" + addr : "") + "]";
	}
...
class Regular extends Employee{
	...
	@Override
	public String toString() {
		return "Regular [salary=" + salary + ", " + (name != null ? "name=" + name + ", " : "") + "age=" + age + ", "
				+ (addr != null ? "addr=" + addr : "") + "]";
	}
